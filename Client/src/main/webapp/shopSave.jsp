	...
	$.ajax({  
	    ...
	    success:function(images){ 
	    	$.each(images, function(i, image){
	    		buttons = '<button class = "shop'+image.brand+image.id + '"' + " id = " + image.id +' type="button">'+ "Add to cart</button>";
	    		imageS += '<img class='+image.brand+image.id + " id = " + image.id  + ' src="'+image.photo +'">' + buttons;
	    	});
...
<body>
    ...
    <select id="selectorb" onchange = "select()">
    ...
    <select id="selectorp" onchange = "select()">
	<option> 0~600 </option>
	<option> 0~100 </option>
	...
	<select id="selectors" onchange = "select()">
	<option> 0~15 </option>
	<option> 0~8 </option>
	<option> 8~12 </option>
	<option> 12~15 </option>
